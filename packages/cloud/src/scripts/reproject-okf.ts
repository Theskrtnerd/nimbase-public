...
//
//   pnpm -F @acme/cloud reproject:okf -- --check    # report drift, write nothing
//   pnpm -F @acme/cloud reproject:okf               # repair drift
//   pnpm -F @acme/cloud reproject:okf -- --workspace <id>
//
