 ...
 *
 * The artifact sandbox loads the pinned Tailwind v3 runtime, so custom colors are
 ...
 *
 * IMPORTANT: place this AFTER the Tailwind runtime <script> — the Play runtime
 * reads `tailwind.config` after it loads.
 */
export const ARTIFACT_THEME_HEAD = `<style>
:root {
  --accent-hue: 248;
